...
from distractingdmc2gym import natural_imgsource
        ...
        if img_source is not None:
            ...
            if img_source == "color":
                ...
                if img_source == "images":
                    self._bg_source = natural_imgsource.RandomImageSource(shape2d, files, grayscale=self._grayscale, total_frames=total_frames)
                elif img_source == "video":
                    self._bg_source = natural_imgsource.RandomVideoSource(shape2d, files, grayscale=self._grayscale, total_frames=total_frames)
                else:
